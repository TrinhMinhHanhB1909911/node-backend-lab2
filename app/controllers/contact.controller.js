...
exports.findAll = async (req, res, next) => {
    ...
    try {
        ...
        return new ApiError(500, 'An error occured while retrieving contacts')
    }
...
exports.findOne = async (req, res, next) => {
    try {
        ...
        if (!document) {
            return next(new ApiError(404, 'Contact can not found'));
        }
        return res.send(document);
    } catch (error) {
        return next(
...
exports.findAllFavorite = async (req, res, next) => {
    try {
        ...
        return next(
            new ApiError(500, 'An error occurred while retriving favorite contacts')
        );
    }
};